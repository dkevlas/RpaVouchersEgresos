    ...
    try:
        ...
        if nombre_exe.lower() in check.stdout.lower():
            ...
            if resultado == 0:
                ...
                # Esperar a que el proceso desaparezca del tasklist
                for _ in range(5):
                    time.sleep(2)
                    ...
                    if nombre_exe.lower() not in check2.stdout.lower():
                        print("Proceso confirmado como terminado.")
                        return True
                print("Advertencia: el proceso aun aparece en tasklist tras esperar.")
                return True
            else:
